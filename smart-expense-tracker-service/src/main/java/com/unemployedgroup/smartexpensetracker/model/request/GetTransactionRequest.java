...
public class GetTransactionRequest {
    ...
    public GetTransactionRequest(Long id, String category_id, BigDecimal amount, String type, LocalDate transaction_date, String merchant_or_source, String note, String input_method, Long receipt_upload_id, Long voice_entry_id) {
        this.id = id;
